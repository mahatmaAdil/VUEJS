  ...
  <main class="auth" role="main">
    ...
    <section class="left" aria-label="Login form">
      <div class="left__inner">
        ...
        <p class="sub">
          The login page prioritizes user security offering a seamless experience
          that ensures quick and convenient access to the system's array of benefits.
        </p>
      ...
      <div class="hero">
        ...
        <div class="overlay">
          <div class="overlay__inner">
            <p class="quote">
              "Elevating access for modern needs - introducing Smart Lockers, where convenience meets security."
            </p>
